...
namespace DataAccess
{
    public class ContactRepo : IContactRepo
    {
        ...
        {
            Contact? contact = _context.contact.FirstOrDefault(contact => contact.email == email);
        ...
        {
            Contact? contact = _context.contact.FirstOrDefault(contact => contact.contactID == contactID);
            if (contact != null) return contact;
            throw new NotImplementedException();
        }
        ...
        {
            Contact? contact = _context.contact.FirstOrDefault(contact => contact.phone == phone);
            if (contact != null) return contact;
            throw new NotImplementedException();
        }
